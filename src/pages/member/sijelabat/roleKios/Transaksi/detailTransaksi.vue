    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" >
        ...
        <q-card flat>
          ...
          <q-card-section>
            <span><b>{{dataAlamat.member ? dataAlamat.member.ktp.nama.toUpperCase() : ''}}</b></span><br />
...
export default {
  ...
  methods: {
    ...
    getDetailRiwayat () {
      this.$showLoading()
      this.$axios.get(`sijelabat/kios/list-transaksi/detail/${this.$route.params.id}`, this.$createToken())
        .finally(() => this.$hide())
        .then(res => {
          // console.log(res)
    ...
    konfirmasiPemesanan (status) {
      this.$showLoading()
      this.$axios.put(`sijelabat/kios/list-transaksi/konfirmasi-pemesanan/${this.$route.params.id}`,
        {
    ...
    konfirmasiPembayaran (status) {
      this.$showLoading()
      this.$axios.put(`sijelabat/kios/list-transaksi/konfirmasi-pembayaran/${this.$route.params.id}`,
        {
          kode_order_status: status,
          feedback_penjual: this.alasanTolak,
