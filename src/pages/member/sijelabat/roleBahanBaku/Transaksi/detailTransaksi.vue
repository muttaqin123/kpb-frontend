...
export default {
  ...
  methods: {
    ...
    getDetailRiwayat () {
      this.$showLoading()
      this.$axios.get(`sijelabat/bahan-baku/list-transaksi/detail/${this.$route.params.id}`, this.$createToken())
        .finally(() => this.$hide())
        .then(res => {
          // console.log(res)
    ...
    konfirmasiPemesanan (status) {
      this.$showLoading()
      this.$axios.put(`sijelabat/bahan-baku/list-transaksi/konfirmasi-pemesanan/${this.$route.params.id}`,
        {
    ...
    konfirmasiPembayaran (status) {
      this.$showLoading()
      this.$axios.put(`sijelabat/bahan-baku/list-transaksi/konfirmasi-pembayaran/${this.$route.params.id}`,
        {
          kode_order_status: status,
          feedback_penjual: this.alasanTolak,
