...
export default {
  ...
  methods: {
    getData () {
      this.loading = true
      this.$axios.get(`opt/pengaduan-by-nik/${this.$getProfile().nik}`, this.$createToken())
    ...
    lihatJawaban (data) {
      this.jawaban = data.opt_jawaban[0]
